...
class ReadMe(object):
    ...
    def regenerate(self):
        ...
        with open(self.filename, 'a') as f:
            ...
            f.write("| DNS 拦截 Lite | [原始链接](https://raw.githubusercontent.com/C9LG/DNS-Blocklists/main/rules/adblockdnslite.txt) | [加速链接](https://raw.gitmirror.com/C9LG/DNS-Blocklists/main/rules/adblockdnslite.txt) |\n")
            f.write("\n")
            f.write("## 上游规则源\n")
