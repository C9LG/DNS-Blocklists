...
class Filter(object):
    ...
    def __generateDNSLite(self, blockList:List[str], unblockList:List[str], ChinaSet:Set[str], fileName:str, sourceRule:str):
        ...
        with open(fileName, 'a') as f:
            ...
            f.write("! Homepage: https://github.com/C9LG/DNS-Blocklists\n")
            f.write("! Source: https://raw.githubusercontent.com/C9LG/DNS-Blocklists/main/rules/adblockdnslite.txt\n")
            f.write("! Version: %s\n"%(time.strftime("%Y%m%d%H%M%S", time.localtime())))
            f.write("! Last modified: %s\n"%(time.strftime("%Y/%m/%d %H:%M:%S", time.localtime())))
            f.write("! Blocked domains: %s\n"%(len(blockList_lite)))
    ...
    def __generateDomain(self, blockList:List[str], fileName:str, sourceRule:str):
        ...
        with open(fileName, 'a') as f:
            ...
            f.write("! Description: 适用于 InviZible Pro、personalDNSfilter 的去广告合并规则。\n")
            f.write("! Homepage: https://github.com/C9LG/DNS-Blocklists\n")
            f.write("! Source: https://raw.githubusercontent.com/C9LG/DNS-Blocklists/main/rules/adblockdomain.txt\n")
            f.write("! Version: %s\n"%(time.strftime("%Y%m%d%H%M%S", time.localtime())))
            f.write("! Last modified: %s\n"%(time.strftime("%Y/%m/%d %H:%M:%S", time.localtime())))
            f.write("! Blocked domains: %s\n"%(len(blockList)))
            f.write("!\n")
    ...
    def __generateDomainLite(self, blockList:List[str], ChinaSet:Set[str], fileName:str, sourceRule:str):
        ...
        with open(fileName, 'a') as f:
            ...
            f.write("! Description: 适用于 InviZible Pro、personalDNSfilter 的去广告合并规则。Lite 版仅针对国内域名拦截。\n")
            f.write("! Homepage: https://github.com/C9LG/DNS-Blocklists\n")
            f.write("! Source: https://raw.githubusercontent.com/C9LG/DNS-Blocklists/main/rules/adblockdomainlite.txt\n")
            f.write("! Version: %s\n"%(time.strftime("%Y%m%d%H%M%S", time.localtime())))
            f.write("! Last modified: %s\n"%(time.strftime("%Y/%m/%d %H:%M:%S", time.localtime())))
            f.write("! Blocked domains: %s\n"%(len(blockList_lite)))
            f.write("!\n")
    ...
    def __generateDNSMasq(self, blockList:List[str], fileName:str, sourceRule:str):
        ...
        with open(fileName, 'a') as f:
            ...
            f.write("# Description: 适用于 DNSMasq 的去广告合并规则。\n")
            f.write("# Homepage: https://github.com/C9LG/DNS-Blocklists\n")
            f.write("# Source: https://raw.githubusercontent.com/C9LG/DNS-Blocklists/main/rules/adblockdnsmasq.txt\n")
            f.write("# Version: %s\n"%(time.strftime("%Y%m%d%H%M%S", time.localtime())))
            f.write("# Last modified: %s\n"%(time.strftime("%Y/%m/%d %H:%M:%S", time.localtime())))
            f.write("# Blocked domains: %s\n"%(len(blockList)))
            f.write("#\n")
    ...
    def __generateDNSMasqLite(self, blockList:List[str], ChinaSet:Set[str], fileName:str, sourceRule:str):
        ...
        with open(fileName, 'a') as f:
            ...
            f.write("# Description: 适用于 DNSMasq 的去广告合并规则。Lite 版仅针对国内域名拦截。\n")
            f.write("# Homepage: https://github.com/C9LG/DNS-Blocklists\n")
            f.write("# Source: https://raw.githubusercontent.com/C9LG/DNS-Blocklists/main/rules/adblockdnsmasqlite.txt\n")
            f.write("# Version: %s\n"%(time.strftime("%Y%m%d%H%M%S", time.localtime())))
            f.write("# Last modified: %s\n"%(time.strftime("%Y/%m/%d %H:%M:%S", time.localtime())))
            f.write("# Blocked domains: %s\n"%(len(blockList_lite)))
            f.write("#\n")
